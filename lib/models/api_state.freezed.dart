...
class __$$LoadingStateImplCopyWithImpl<T, $Res>
    extends _$ApiStateCopyWithImpl<T, $Res, _$LoadingStateImpl<T>>
...
abstract class LoadingState<T> implements ApiState<T> {
...
class __$$SuccessStateImplCopyWithImpl<T, $Res>
    extends _$ApiStateCopyWithImpl<T, $Res, _$SuccessStateImpl<T>>
...
abstract class SuccessState<T> implements ApiState<T> {
  const factory SuccessState({required final T data}) = _$SuccessStateImpl<T>;
...
class __$$ErrorStateImplCopyWithImpl<T, $Res>
    extends _$ApiStateCopyWithImpl<T, $Res, _$ErrorStateImpl<T>>
